...
ciudades_spain_data <- read_csv("ciudades_spain.csv", 
                                  +locale = locale(encoding ="WINDOWS-1252"))


datos_modificados <- read_csv("C:/Users/cotot/OneDrive/Desktop/datos_modificados.csv", 
                              +     locale = locale(encoding = "WINDOWS-1252"))
fix(datos_modificados)





mapa_spain_data<-left_join(ciudades_Spain,datos_modificados,by="NAME_2")
```
